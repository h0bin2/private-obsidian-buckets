---
name: write-skill
description: 작성 목적을 분류하고 목적별 참조 문서를 선택해 Obsidian Markdown 문서 작성 규칙을 적용한다. 논문, 프로젝트 생성, PRD, 요약, 인수인계, 캔버스(시스템 아키텍처), 일반 문서 작성/수정 작업에서 사용한다.
---
...
## 공통 저장 경로 규칙
- `projects` 목적은 `PROJECT/<순번_프로젝트명>/` 루트를 생성한다.
- `prd` 또는 `canvas` 목적 문서는 `PROJECT/<순번_프로젝트명>/docs/` 아래에 저장한다.
